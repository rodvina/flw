...
<div class="shortrow">
<H3 align="center"><a href="search?action=return">Return to Search</a> -> Form Details</H3>
</div>
...
//			"sDom": '<"top"fi>t<"bottom"><"clear">',
			...
			"oTableTools": {
				...
				"sSwfPath": "<c:url value='/resources/media/copy_csv_xls_pdf.swf'/>"
			},
			"bProcessing": false,
